...
* [fvm](https://github.com/leoafarias/fvm) ⭐ 5,523 | 🐛 39 | 🌐 Dart | 📅 2026-09-18 - A version manager allowing to reference Flutter SDK version on a per-project basis, allows you to have multiple versions installed.
...
* [bob](https://github.com/MordechaiHadad/bob) ⭐ 2,143 | 🐛 17 | 🌐 Rust | 📅 2026-09-19 - A cross-platform and easy-to-use Neovim version manager, allowing for easy switching between versions right from the command line.
